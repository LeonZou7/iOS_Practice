...
- (void)viewDidLoad {
     ...
     */
    UILabel* headLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 44)];
    [headLabel setText:@"Cities"];
    ...
    [tableView setTableFooterView:headLabel];   //设置页眉
...
-(UITableViewCell*) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.textLabel setText:[appDelegate.cities objectAtIndex:rowIndex]];   //根据行号设置文本
    [cell.detailTextLabel setText:[appDelegate.details objectAtIndex:rowIndex]];    //设置详细文本
...
-(void) tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    [appDelegate.cities removeObjectAtIndex:indexPath.row];     //从数据源处删除
